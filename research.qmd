...
\normalsize Anna Weissman and Anna Mikkelborg, **"As Racial Attitudes Go, So Goes Approval: Why White Democrats Favor Representatives of Color"**, *forthcoming at Political Behavior*

<details>

<summary><strong>[Abstract]{style="font-size:0.8em"}</strong> <a href="papers/Weissman&Mikkelborg_Behavior_Forthcoming.pdf" target="_blank" title="Download PDF" style="margin-left:8px;"> <i class="fa-solid fa-file-pdf"></i> </a></summary>
