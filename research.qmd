...
<summary><strong>[Abstract]{style="font-size:0.8em"}</strong> <a></a></summary>

Access to political power often depends on informal judgments of who is qualified to govern. Given that local officials primarily navigate place-specific institutions and issues, I argue that a distinct logic of political selection operates in municipal politics. I advance a theory of local roots as a central criterion of local credibility. Using a novel dataset of municipal campaign statements, linked voter file and candidate records, and original nationwide surveys of elected officials and constituents, I show that local roots pervasively shape who runs for office, how candidates present themselves to voters, who ultimately governs, and how voters perceive those in power. While individuals value the presence of long-term residents in office, the overrepresentation of rooted constituents may translate into substantive underrepresentation for newcomers when long- and short-term residents diverge in their policy preferences. These findings illustrate how widely accepted informal qualifications can generate democratic inequality upstream.
