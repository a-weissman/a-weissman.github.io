...
How does place-based connection structure democratic representation? While scholars have studied the effects of legislators’ local roots in state and national politics, this question remains largely overlooked in the context where it should matter most: municipal governance. Local officials must navigate highly place-specific institutions and community needs. Using a novel dataset of campaign statements, linked voter file and candidate records, and original nationwide surveys of elected officials and the public, I show that local roots shape who runs for office, who governs, and whose interests are represented. Nearly all candidates highlight their local ties, and most candidates and officials have lived in their municipalities for decades. The electorate, by contrast, is more mobile, making deeply rooted residents descriptively overrepresented, especially in cities with many transient residents. This can translate into substantive underrepresentation for newcomers when long- and short-term residents diverge in their local policy preferences. Indeed, I find evidence that this divergence is likely, especially on land use and growth-related issues. Together, the results highlight the importance of place-based connection in understanding whose voices are heard in local democracy.
</details>
