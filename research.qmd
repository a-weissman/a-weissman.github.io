...
Decision-making in a municipal government demands deep knowledge of the town or city, but studies of local politics largely overlook the role of geographic ties in local representation. I argue that local roots function as a political qualification for local office, shaping who runs, who wins, and whose interests are represented. To support this argument, I draw on an original dataset of campaign statements, linked voter file and candidate records, and nationwide surveys of elected officials and the public. I find that nearly all candidates highlight their local connections, and most have lived in their municipalities for decades. These patterns are consistent across municipality size and stand in stark contrast to the more mobile general electorate, particularly in larger cities. However, regardless of constituents' own residency tenure, they view rootedness as a signal of credibility. Simultaneously, they perceive differences in long-term residents' and newcomers' policy preferences. This means that despite the favorability of rooted candidates, their dominance in office may lead to the marginalization of more transient constituents' views. These findings reveal how connection to place structures who governs, and by extension, whose interests are heard.
