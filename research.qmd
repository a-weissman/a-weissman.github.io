...
How does place-based connection structure local representation? Municipal policymaking demands deep place-based knowledge, but existing work overlooks local officials’ ties to their communities. I argue that local roots function as a political qualification for local office, shaping who runs, who wins, and whose interests are represented. To support this argument, I draw on an original dataset of campaign statements, linked voter file and candidate records, and nationwide surveys of elected officials and the public. I find that nearly all candidates highlight their local connections, and most have lived in their municipalities for decades. These patterns hold across municipality size and stand in stark contrast to the more mobile general electorate, particularly in larger cities. Moreover, regardless of constituents' own residency tenure, they view rootedness as a signal of credibility. They also associate strong roots with preservationist policy preferences, meaning that despite favorability of rooted candidates, long-term residents' dominance in office may lead to the marginalization of more transient constituents' views. These findings both reveal how connection to place structures who governs and underscore the broader importance of understanding who holds political power at the local level.
</details>
